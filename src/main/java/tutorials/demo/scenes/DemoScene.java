package tutorials.demo.scenes;

import tutorials.core.*;
import tutorials.core.behavior.Behavior;
import tutorials.core.entity.*;
import tutorials.core.entity.weather.*;
import tutorials.core.physic.Material;
import tutorials.core.scene.AbstractScene;
import tutorials.core.scene.Scene;
import tutorials.core.utils.Log;
import tutorials.core.utils.Utils;
import tutorials.core.gfx.sfx.OldTerminalVFX;
import tutorials.core.simulation.Sky;
import tutorials.core.simulation.StarSky;
import tutorials.core.simulation.Sun;
...
import static tutorials.core.io.InputHandler.isKeyPressed;
...
public class DemoScene extends AbstractScene implements Scene {
    ...
    public void init() {
        ...
        app.getRenderer().addVFX(new OldTerminalVFX(0.2f, 2.0f));
