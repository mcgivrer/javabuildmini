...
import tutorials.core.io.OnKeyEvent;
...
import static tutorials.core.utils.Log.debug;
...
public abstract class AbstractScene implements Scene, OnKeyEvent {
    ...
    public void add(Entity e) {
        ...
        entities.add(e);
        debug(AbstractScene.class, 2, "|_ Adding Entity '%s' [%s]", e.getName(), e.getClass());
    }
